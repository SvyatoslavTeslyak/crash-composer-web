...
(()=>{
 ...
 const explain=()=>{
  for(const id of ['library-controls']){
  ...
  for(const element of document.querySelectorAll('#library-report .use-select,#library-report [data-remove],#library-google,#library-google-add,#library-upload,#library-file,#icon-add,#icon-file,#library-report [data-replace],#library-report [data-drop]')){element.disabled=true;element.title='File editing is available in the local Composer.'}
 };
